...
import Management_Employees_Unit_Table from '../../components/Management_Employees/Unit/Management_Employees_Unit_Table';
import Management_Employees_Unit_ChildInput from '../../components/Management_Employees/Unit/Management_Employees_Unit_ChildInput';
import { useDispatch, useSelector } from 'react-redux';
import { MODE } from '../../constant/constant';
import { getUnit } from '../../store/employees/employee/unitSlice';

const Management_Employees_Unit = () => {
    ...
    return (
        <div>
            ...
            <Row>
                <Col span={24}>
                    <Management_Employees_Unit_Table
                        dataTable={dataTable}
            ...
            {isChildInputOpen ? (
                <Management_Employees_Unit_ChildInput
...
export default Management_Employees_Unit;
