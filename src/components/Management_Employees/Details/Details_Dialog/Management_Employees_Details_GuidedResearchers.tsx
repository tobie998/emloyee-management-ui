...
interface DataType {
    key: number;
    employeeID: string;
    guidedResearcherID: string;
    guidedResearcherName: string;
    role: string;
    workingSpace: string;
    guidedResearcherYear: string;
}
...
const GuidedResearchers_ChildInput: React.FC<childInputProps> = (props: childInputProps) => {
...
const Management_Employees_Details_GuidedResearchers: React.FC<Props> = (props: Props) => {
    ...
    const columns: ColumnsType<DataType> = [
        ...
        {
            title: 'Mã NCS',
            dataIndex: 'guidedResearcherID',
            key: 'guidedResearcherID',
            width: '150px',
        },
        {
            title: 'Tên NCS',
            key: 'guidedResearcherName',
            dataIndex: 'guidedResearcherName',
            width: '100px',
        },
        {
            title: 'Vai trò',
        ...
        },
        {
            ...
            key: 'workingSpace',
            dataIndex: 'workingSpace',
            width: '150px',
        },
        {
            title: 'Năm bảo vệ của NCS',
            key: 'guidedResearcherYear',
            dataIndex: 'guidedResearcherYear',
            width: '150px',
        },
        {
            title: '',
    ...
    const data: DataType[] = [
        {
            key: 1,
            employeeID: 'CB0001',
            guidedResearcherID: 'NCS0001',
            guidedResearcherName: 'Nguyễn Văn A',
            role: 'Đồng hướng dẫn',
            workingSpace: 'Học viện',
            guidedResearcherYear: '2023-05-08',
        },
        {
            key: 2,
            employeeID: 'CB0002',
...
export default Management_Employees_Details_GuidedResearchers;
