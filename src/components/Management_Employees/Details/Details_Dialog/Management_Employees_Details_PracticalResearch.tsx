...
interface DataType {
    key: number;
    employeeID: string;
    practicalResearchID: string;
    practicalResearchName: string;
    practicalResearchForm: string;
    scale: string;
...
const PracticalResearch_ChildInput: React.FC<childInputProps> = (props: childInputProps) => {
    ...
    return (
        <div className="absolute w-full h-full top-0 left-0 flex justify-center items-center z-50 ">
            <Card
                title={`Công trình và kết quả nghiên cứu được áp dụng [${mode}]`}
            ...
            >
                <Row gutter={[32, 32]} className="mb-5">
                    ...
                    <Col span={8}>
                        <Input_Text
                            label="Mã công trình nghiên cứu"
                            value={`employeeName`}
                            onChange={() => {
                                console.log('abcd');
                            }}
                    ...
                    <Col span={8}>
                        <Input_Text
                            label="Tên công trình nghiên cứu"
                            value={`employeeName`}
                            onChange={() => {
                                console.log('abcd');
                            }}
...
const Management_Employees_Details_PracticalResearch: React.FC<Props> = (props: Props) => {
    ...
    const columns: ColumnsType<DataType> = [
        ...
        {
            title: 'Mã công trình nghiên cứu',
            dataIndex: 'practicalResearchID',
            key: 'practicalResearchID',
            width: '150px',
        },
        {
            title: 'Tên công trình nghiên cứu',
            key: 'practicalResearchName',
            dataIndex: 'practicalResearchName',
            width: '100px',
        },
        {
            title: 'Hình thức',
            key: 'practicalResearchForm',
            dataIndex: 'practicalResearchForm',
            width: '100px',
        },
        {
            title: 'Quy mô',
        ...
        {
            title: 'Địa chỉ áp dụng',
            key: 'appliedLocation',
            dataIndex: 'appliedLocation',
            width: '150px',
        },
        {
            title: 'Thời gian',
    ...
    const data: DataType[] = [
        {
            key: 1,
            employeeID: 'CB0001',
            practicalResearchID: 'CTAD0001',
            practicalResearchName: 'Công trình 1',
            practicalResearchForm: 'Sản phẩm thực tế',
            scale: 'Cấp thành phố',
            appliedLocation: 'Thành phố',
            period: '2023-05-08',
        },
        {
            key: 2,
...
export default Management_Employees_Details_PracticalResearch;
