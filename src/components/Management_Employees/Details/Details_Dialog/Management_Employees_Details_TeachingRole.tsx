...
const TeachingRole_ChildInput: React.FC<childInputProps> = (props: childInputProps) => {
...
const Management_Employees_Details_TeachingRole: React.FC<Props> = (props: Props) => {
    ...
    const data: DataType[] = [
        {
            key: 1,
            employeeID: 'CB0001',
            teachingRoleID: 'CD0001',
            teachingRoleName: 'Giảng viên chính',
        },
        {
            key: 2,
            employeeID: 'CB0002',
...
export default Management_Employees_Details_TeachingRole;
