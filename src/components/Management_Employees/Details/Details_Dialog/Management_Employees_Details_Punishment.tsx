...
const Punishment_ChildInput: React.FC<childInputProps> = (props: childInputProps) => {
...
const Management_Employees_Details_Punishment: React.FC<Props> = (props: Props) => {
...
export default Management_Employees_Details_Punishment;
