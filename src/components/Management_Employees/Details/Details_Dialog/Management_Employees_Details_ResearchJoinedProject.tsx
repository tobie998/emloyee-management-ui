...
interface DataType {
    key: number;
    employeeID: string;
    researchJoinedProjectID: string;
    researchJoinedProjectName: string;
    startTime: string;
    endTime: string;
    status: string;
}
...
const ResearchJoinedProject_ChildInput: React.FC<childInputProps> = (props: childInputProps) => {
    ...
    return (
        <div className="absolute w-full h-full top-0 left-0 flex justify-center items-center z-50 ">
            <Card
                title={`Đề tài dự án KH&CN tham gia [${mode}]`}
...
const Management_Employees_Details_ResearchJoinedProject: React.FC<Props> = (props: Props) => {
    ...
    const columns: ColumnsType<DataType> = [
        ...
        {
            title: 'Mã đề tài KH&CN tham gia',
            dataIndex: 'researchJoinedProjectID',
            key: 'researchJoinedProjectID',
            width: '150px',
        },
        {
            title: 'Tên đề tài KH&CN',
            key: 'researchJoinedProjectName',
            dataIndex: 'researchJoinedProjectName',
            width: '100px',
        },
        {
    ...
    const data: DataType[] = [
        {
            key: 1,
            employeeID: 'CB0001',
            researchJoinedProjectID: 'DTTG0001',
            researchJoinedProjectName: 'Đề tài tham gia 1',
    ...
    return (
        <div className="absolute w-full h-full top-0 left-0 flex justify-center items-center z-50 ">
            ...
            >
                ...
                {isOpenChildInput ? (
                    <ResearchJoinedProject_ChildInput
                        mode="add"
...
export default Management_Employees_Details_ResearchJoinedProject;
