...
const WorkingRole_ChildInput: React.FC<childInputProps> = (props: childInputProps) => {
...
const Management_Employees_Details_WorkingRole: React.FC<Props> = (props: Props) => {
    ...
    const data: DataType[] = [
        {
            key: 1,
            employeeID: 'CB0001',
            workingRoleID: 'CV0001',
            workingRoleName: 'Nhân viên',
        },
        {
            key: 2,
            employeeID: 'CB0002',
...
export default Management_Employees_Details_WorkingRole;
