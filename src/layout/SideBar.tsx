    ...
    const menuItem: MenuProps['items'] = [
        {
            ...
            children: [
                ...
                { label: <Link to="/employees-research-assessment">Kinh nghiệm KH&CN</Link>, key: 17 },
                { label: <Link to="/employees-research-category">Lĩnh vực nghiên cứu KH</Link>, key: 18 },
                { label: <Link to="/employees-research-major">Chuyên ngành KH&CN</Link>, key: 19 },
                { label: <Link to="/employees-language-knowledge">Trình độ ngoại ngữ</Link>, key: 20 },
                { label: <Link to="/employees-award">Giải thưởng</Link>, key: 21 },
                { label: <Link to="/employees-reward">Khen thưởng</Link>, key: 22 },
                { label: <Link to="/employees-punishment">Kỷ luật</Link>, key: 23 },
                { label: <Link to="/employees-research-project">Đề tài KH&CN</Link>, key: 24 },
                { label: <Link to="/employees-research-public-research">Công trình KH&CN</Link>, key: 25 },
            ],
        },
        {
